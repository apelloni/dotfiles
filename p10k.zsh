# Generated by Powerlevel10k configuration wizard on 2021-04-02 at 15:33 CEST.
...
#    # example               # example user-defined segment (see prompt_example function below)
  ...
  #typeset -g POWERLEVEL9K_BACKGROUND=237  #Gray
  typeset -g POWERLEVEL9K_BACKGROUND=232  #Black
  ...
  #typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%F{red}%F{green}%F{blue}%F{$POWERLEVEL9K_BACKGROUND}%f'
  typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL="%F{red}\uf444%F{green}\uf444%F{blue}\uf444%F{$POWERLEVEL9K_BACKGROUND}%f"
